  ...
  return (
    <div className='w-[20%] h-full  border-r-2 border-zinc-400 p-3 ' >
        ...
        <nav className='flex flex-col text-zinc-400 text-xl gap-3'>
            ...
            <Link className="hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-5"> <i className="ri-bard-fill"></i> Popular</Link>
            <Link className="hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-5"><i className="ri-movie-2-fill"></i> Movies</Link>
            <Link className="hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-5"><i className="ri-tv-2-fill"></i> Tv Shows</Link>
        ...
        <nav className='flex flex-col text-zinc-400 text-xl gap-3'>
            ...
            <Link className="hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-5"> <i className="ri-information-fill"></i> About MovieFlix</Link>
